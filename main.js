...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/j2JQHvGej/model.json',modelLoaded);
...
function gotResults(error, results){
    if(error){
        ...
        if(results[0].label == "thumbs down"){
            document.getElementById("result_emoji").innerHTML = "&#128078;";
            document.getElementById("quote").innerHTML = "you did a bad job";
        }
